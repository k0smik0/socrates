 ...
 * 
 * PlaceConfigXmlParserProvider.java is part of socrates_config-xml.
 * 
...
public class PlaceConfigXmlParserProvider implements Provider<PlaceConfigXmlParser> {
	...
	@Inject
	public PlaceConfigXmlParserProvider(XmlAssetReader<PlaceConfigXml> xmlAssetReader) {
		this.xmlAssetReader = xmlAssetReader;
	}
	
	@Override
	public PlaceConfigXmlParser get() {
		return new PlaceConfigXmlParser(xmlAssetReader);
	}
}
