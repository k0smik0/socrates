 ...
 ******************************************************************************/
package net.iubris.socrates.model.data.place;

import com.google.api.client.util.Value;

public enum PlaceType {	
	@Value accounting,       @Value airport,				@Value amusement_park,		@Value aquarium,	@Value art_gallery,    @Value atm,		     @Value bakery,  @Value bank,    @Value bar,     @Value beauty_salon,    @Value bicycle_store, 
	@Value book_store,      	@Value bowling_alley, 	@Value bus_station,     @Value cafe,    @Value campground,      
	@Value car_dealer,			@Value car_rental,      @Value car_repair,      @Value car_wash,      @Value casino,  @Value cemetery,        
	@Value church,  				@Value city_hall,       @Value clothing_store,  @Value convenience_store,       @Value courthouse,      
	@Value dentist, 				@Value department_store,      @Value doctor,  @Value electrician,     @Value electronics_store,       
	@Value embassy,			@Value establishment,   @Value finance, @Value fire_station,    @Value florist, @Value food,    
	@Value funeral_home,	@Value furniture_store, @Value gas_station,     @Value general_contractor,      
