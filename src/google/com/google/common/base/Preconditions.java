...
public final class Preconditions {
    ...
    public static int checkElementIndex(int index, int size, String desc) {
        ...
        if (index < 0 || index >= size) {
            throw new IndexOutOfBoundsException(badElementIndex(index,
                    size, desc));
        }
        return index;
    }
    ...
    private static String badElementIndex(int index, int size,
        ...
        if (index < 0) {
            ...
            return format("%s (%s) must be less than size (%s)", desc,
                    index, size);
        }
    }
    ...
    public static int checkPositionIndex(int index, int size,
        ...
        // Carefully optimized for execution by hotspot (explanatory comment above)
        if (index < 0 || index > size) {
            throw new IndexOutOfBoundsException(badPositionIndex(index,
                    size, desc));
        }
        return index;
    }
    ...
    private static String badPositionIndexes(int start, int end,
            int size) {
