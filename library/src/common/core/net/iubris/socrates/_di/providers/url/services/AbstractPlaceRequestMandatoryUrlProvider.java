 ...
 ******************************************************************************/
package net.iubris.socrates._di.providers.url.services;
...
public abstract class AbstractPlaceRequestMandatoryUrlProvider implements Provider<GenericUrl>{
	...
	public AbstractPlaceRequestMandatoryUrlProvider(ServiceType serviceType, GenericUrl genericUrl, ConfigMandatory config) {
		this.serviceType = serviceType;
		this.urlWithoutParameters = genericUrl;
		this.config = config;
	}
