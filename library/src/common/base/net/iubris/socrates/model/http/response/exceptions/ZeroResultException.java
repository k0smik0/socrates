 ...
 * 
 * ZeroResultException.java is part of 'Socrates'.
 * 
 ...
 */
public class ZeroResultException extends StatusException {

	private static final long serialVersionUID = 326224504515929176L;

	public ZeroResultException(String reason) {
		super(reason);
	}
	public ZeroResultException(Throwable cause) {
		super(cause);
	}
}
